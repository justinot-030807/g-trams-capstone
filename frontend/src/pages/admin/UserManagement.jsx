                      ...
                      <td className="py-3 pl-5 pr-3">
                        <div className="flex items-center gap-3">
                          <div className="relative shrink-0">
                            <div className={`w-9 h-9 rounded-full overflow-hidden flex items-center justify-center border-2 shadow-sm ${user.isActive === false ? 'border-red-300 dark:border-red-800 bg-red-100 dark:bg-red-950/50 text-red-400' : 'border-white dark:border-slate-700 bg-slate-200 dark:bg-slate-800 text-slate-600 dark:text-slate-400'}`}>
                              {user.profilePic ? (
            ...
            <div className="bg-[#7A1B22] p-6 text-center relative shrink-0">
              ...
              <div className="relative inline-block mx-auto mb-3">
                <div className="w-20 h-20 bg-slate-100 rounded-full flex items-center justify-center shadow-md border-2 border-[#D4AF37] overflow-hidden">
                  {selectedUser.profilePic ? <img src={selectedUser.profilePic} alt={selectedUser.name} className="w-full h-full object-cover" /> : <User className="text-slate-600 dark:text-slate-400" size={36} />}
                </div>
                      ...
                      <div key={unit._id || idx} className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700/80 rounded-xl p-3 shadow-2xs">
                        <div className="flex items-center justify-between mb-1.5">
                          ...
                          <span className={`px-2 py-0.5 rounded-full text-xs font-bold uppercase tracking-wider border ${
                            ...
                            unit.status === 'For Signing' ? 'bg-purple-50 dark:bg-purple-950/40 text-purple-700 dark:text-purple-400 border-purple-200 dark:border-purple-800' :
