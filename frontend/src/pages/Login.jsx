      ...
      <div className="w-full max-w-[350px] sm:max-w-[390px] my-auto relative z-10 animate-card-entrance">
        <div className="bg-white/95 backdrop-blur-2xl rounded-2xl sm:rounded-3xl shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)] border border-white/50 p-5 sm:p-7">
          ...
          <div className="flex flex-col items-center mb-5 text-center">
            ...
            <h2 className="text-xl font-black text-slate-900 tracking-tight animate-item-1">G-TRAMS Portal</h2>
            <div className="flex items-center justify-center gap-1 mt-0.5 text-[10px] sm:text-xs font-semibold text-slate-500 uppercase tracking-wider animate-item-1">
          ...
          {error && (
            <div className="mb-3.5 bg-red-50/90 border border-red-200 text-red-700 text-xs font-semibold rounded-xl p-2.5 text-center shadow-sm">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleLogin} className="space-y-3">
            ...
            <div className="animate-item-3">
              ...
              <div className="relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 hover:text-[#7A1B22] p-1"
                >
            ...
            <div className="flex justify-end animate-item-3">
              <Link to="/forgot-password" className="text-[11px] font-bold text-[#7A1B22] hover:underline">
                Forgot password?
              </Link>
            </div>
            ...
            <div className="animate-item-4 pt-1">
              <button
                type="submit"
                className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-[#7A1B22] via-[#8E2028] to-[#5A1419] text-white py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-bold shadow-lg shadow-[#7A1B22]/25 hover:brightness-110 active:scale-[0.98] transition-all tracking-wide"
              >
                <LogIn size={15} />
                Sign In
              </button>
