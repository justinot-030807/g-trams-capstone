  ...
  return (
    <div className="relative w-full bg-[#120204] text-white flex flex-col overflow-x-hidden select-none">
      ...
      <div className="relative min-h-[100dvh] flex flex-col">
        ...
        {/* MAIN HERO SECTION */}
        <main className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-10 sm:py-5 lg:py-6 flex-grow flex flex-col items-center justify-center text-center">
          ...
          <p className="text-white/75 text-xs sm:text-sm lg:text-base max-w-2xl mt-3 sm:mt-4 leading-relaxed font-normal animate-item-2 px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mt-6 sm:mt-8 w-full max-w-md animate-item-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-8 sm:mt-10 w-full text-left animate-item-4">
            
            <div className="p-4 sm:p-5 rounded-2xl bg-white/10 backdrop-blur-md border border-white/15 shadow-sm hover:bg-white/15 hover:border-[#D4AF37]/40 hover:-translate-y-1 transition-all duration-300">
