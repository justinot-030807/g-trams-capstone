...
const translations = {
  en: {
    ...
    'dashboard.signingTitle': 'Application Approved — Routing for Signature',
    'dashboard.signingDesc': 'Your documents have passed technical verification. Your official MTOP Certificate is currently being printed and routed to municipal authorities for signature. Please wait for the "Ready for Pickup" notice before visiting the Municipal Hall.',
    'dashboard.appProgress': 'Application Progress',
    'dashboard.stepSubmitted': 'Submitted',
    'dashboard.stepReview': 'Review',
    'dashboard.stepSigning': 'For Signing',
    ...
    'dashboard.statusSigning': 'For Signing',
  ...
  fil: {
    ...
    'dashboard.signingTitle': 'Aprubado Na — Kasalukuyang Pinapapirmahan',
    'dashboard.signingDesc': 'Na-verify na ang iyong mga dokumento at ang iyong MTOP Certificate ay kasalukuyang pinapapirmahan sa mga opisyal ng munisipyo. Mangyaring maghintay ng abisong "Handa nang Kunin" bago magtungo sa Munisipyo.',
    'dashboard.appProgress': 'Progreso ng Aplikasyon',
    'dashboard.stepSubmitted': 'Naisumite',
    'dashboard.stepReview': 'Sinusuri',
    'dashboard.stepSigning': 'Pirmahan',
    ...
    'dashboard.statusSigning': 'Pinapapirmahan',
